...
> Enumerable is our second project in ruby programming to understand modules and classes.

**Enumerable** is the ruby project to implement the all, any and filter methods in a module.
...
- **Using a module and class**
- **Using methods in module to perform the operation**
...
- mkdir my-folder
- cd my-folder
- git clone [(https://github.com/Mujeeb4582/Enumerable.git)]
...
Feel free to check the [issues page](https://github.com/Mujeeb4582/Enumerable/issues).
...
This project is [MIT](https://github.com/Mujeeb4582/Enumerable/blob/dev/MIT.md) licensed.
